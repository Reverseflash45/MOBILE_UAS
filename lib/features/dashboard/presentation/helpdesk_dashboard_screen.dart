...
class HelpdeskDashboardScreen
    extends ConsumerStatefulWidget {
  const HelpdeskDashboardScreen({super.key});

  @override
  ConsumerState<HelpdeskDashboardScreen>
      createState() =>
          _HelpdeskDashboardScreenState();
}

class _HelpdeskDashboardScreenState
    extends ConsumerState<HelpdeskDashboardScreen> {
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildMenuCard(
            ...
            title: 'Tugas Saya',
            subtitle:
                'Lihat tiket yang ditugaskan kepada Anda',
            onTap: () {
              Navigator.pushNamed(
                context,
                AppRouter.listTicketRoute,
